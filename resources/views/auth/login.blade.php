              ...
              <form action="{{route('login-proses')}}" method="post"> 
                ...
                <div class="text-center text-lg-start mt-4 pt-2" style="text-align: center">
                  <div class="form-group-btn text-center">
                    <button class="btn-edit-profil" style="  background-color: rgb(71, 93, 33); color:white; border-radius:10px; padding-left: 10rem; padding-right: 10rem; padding-top:5px; padding-bottom:5px  " type="submit" class="">Masuk</button>
                  </div>
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0" style="text-align: center">Belum Punya Akun? <a href=" {{ route('register') }} "
                      class="" style="color: #406EE4; text-decoration: none;">Daftar di sini</a></p>
                </div>
              </form>
            </div>
          </div>
