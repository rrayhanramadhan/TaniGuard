              ...
              <form action="{{route('register-proses')}}" method="post">
                ...
                <div class="text-center text-lg-start mt-4 pt-2 ">
                  <div class="form-group-btn text-center ">
                    <button class="btn-edit-profil" style="  background-color: rgb(71, 93, 33); color:white; border-radius:10px; padding-left: 16rem; padding-right: 15rem; padding-top:5px; padding-bottom:5px; " type="submit" class="">
                      Registrasi
                    </button>
                  </div>
                  ...
                  <p class="small fw-bold mt-2 pt-1 mb-0" style="text-align: center" >Sudah Punya Akun? <a href=" {{ route('login') }} "
                      class="" style="color: #406EE4; text-decoration: none;">Login</a></p>
                </div>
              </form>
            </div>
          </div>
