                ...
                <div class="row ">
                    ...
                    <div class="card card-primary  col-md-12">
                        ...
                        <div class="profil text-center">
                            <a href="{{ route('profil.edit', ['id' => $akun->id]) }}" class="btn-edit-profil text-center"
                                style="color:aliceblue; display: inline-block; ">Edit</a>
                        </div>
                        ...
                        <div class="card-body box-profile">
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Nama Lengkap</b> <a class="float-right">{{ $akun->name }}</a>
                                    {{-- <b>Nama</b>  <a class="float-right">{{$pr->name}}</a> --}}
                                </li>
                                <li class="list-group-item">
                                    <b>Nama Pengguna</b> <a class="float-right">{{ $akun->username }}</a>
